...
namespace Dynatrace.MetricUtils.Tests
{
	public class MetricSerializerTests
    {
        ...
        public void SerializeLongDeltaCounter()
        {
            ...
            var metric = MetricsFactory.CreateLongDeltaCounter("metric1", dimensions, 100, testTimestamp);
            ...
            var metricWithCurrentTimestamp = MetricsFactory.CreateLongDeltaCounter("metric2", dimensions, 200);
